        ...
        <div className="mx-auto max-w-2xl py-14 ">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-5xl">
              Produtos de alta performance para quem exige inovação, velocidade
              e qualidade em cada detalhe.
            </h1>
            <p className="mt-8 text-lg font-medium  text-gray-400 sm:text-lg/8">
              Os melhores produtos de tecnologia em um só lugar. Inovação,
              desempenho e qualidade para você estar sempre à frente.
            </p>
